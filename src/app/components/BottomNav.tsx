      ...
      >
        ...
        >
          <BottomNavigationAction
            ...
            className={`${pathname === '/' && '!text-blue-900'}`}
            icon={
              <svg
          ...
          <BottomNavigationAction
            ...
            className={`${pathname.includes('orders') && '!text-blue-900'}`}
            icon={
              <svg
          ...
          <BottomNavigationAction
            ...
            className={`${pathname.includes('shop') && '!text-blue-900'}`}
            label="Products"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <BottomNavigationAction
            ...
            className={`${pathname.includes('discounts') && '!text-blue-900'}`}
            label="Discounts"
            icon={
              <svg
                width="20"
