                    ...
                    <>
                      ...
                      <div>
                        ...
                        <div className="flex align-baseline sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-2 mt-5">
                          ...
                          <div className="sm:w-1/5 md:w-4/5">
                            <label
                              className="block text-sm font-medium mb-1"
                              htmlFor="option_three_values"
                            >
                              Option 3 Values
                            </label>
                            <input
                              id="option_three_values"
                              name="option_three_values"
                              onChange={handleChange}
                              onBlur={handleBlur}
                              value={values.option_three_values}
                              className="form-input capitalize"
                              type="text"
                              placeholder="Red, Yellow"
                            />
