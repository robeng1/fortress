...
export function* getViews() {
  ...
  const requestURL = `${fortressURL}/shops/${shopId}/product-views`;
  ...
  const query = `SELECT * FROM product WHERE shop_id = '${shopId}' ORDER BY updated_at DESC LIMIT ${offset}, ${countPerPage}`;
  try {
