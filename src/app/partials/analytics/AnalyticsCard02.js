...
function AnalyticsCard02() {
  ...
  return (
    <div className="flex flex-col col-span-full xl:col-span-4 border border-transparent focus:outline-none rounded shadow bg-white px-2 pl-8 appearance-none">
