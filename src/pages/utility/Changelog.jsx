              ...
              <div className="max-w-3xl m-auto mt-8">
                ...
                <div className="xl:pl-32 xl:-translate-x-16 mb-2">
                  <ul className="flex flex-wrap -m-1">
                    <li className="m-1">
                      <button className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm bg-purple-600 text-white duration-150 ease-in-out">
                        View All
                      </button>
                    </li>
                    <li className="m-1">
                      ...
                      <div className="flex-grow pb-6 border-b border-gray-200">
                        <header>
                          ...
                          <div className="flex flex-nowrap items-center space-x-2 mb-4">
                            ...
                            <div className="text-gray-400">·</div>
                            <div>
                              <div className="text-xs inline-flex font-medium bg-light-purple-100 text-light-purple-600 rounded-full text-center px-2.5 py-1">
                                Exciting News
                              </div>
                            </div>
                          </div>
