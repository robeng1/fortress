                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              <svg
                                ...
                                viewBox="0 0 24 24"
                              >
                                <path d="M21,13.5A2.5,2.5,0,0,1,19,16V17a1,1,0,0,1-2,0V16H16a1,1,0,0,1,0-2h2.5a.5.5,0,0,0,0-1h-1A2.5,2.5,0,0,1,17,8.05V7a1,1,0,0,1,2,0V8h1a1,1,0,0,1,0,2H17.5a.5.5,0,0,0,0,1h1A2.5,2.5,0,0,1,21,13.5ZM21,21a1,1,0,0,1-1,1H4a1,1,0,0,1-1-1V9A1,1,0,0,1,4,8H7V3A1,1,0,0,1,8,2h4a1,1,0,0,1,1,1V20h7A1,1,0,0,1,21,21ZM5,20H7V10H5Zm4,0h2V4H9Z" />
                              </svg>
                              <span className="text-sm font-medium ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Finances
                              </span>
