...
function MuiEntityPickerModal({
  ...
  return (
      <div>
        {/* Modal dialog */}
        <ModalBlank modalOpen={modalOpen} setModalOpen={setModalOpen}  id={"shit"}>
            <div className="bg-white overflow-auto px-3 w-full max-h-full rounded shadow-lg">
              {/* Search form */}
...
export default MuiEntityPickerModal;
