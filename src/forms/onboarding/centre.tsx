          ...
          <div className="min-h-screen h-full w-screen flex flex-col after:flex-1">
                ...
                <div className="max-w-md mx-auto w-full">
                  <div className="relative">
                    ...
                    <ul className="relative flex justify-between w-full">
                      ...
                      <li>
                        <Link className="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-indigo-500 text-white" to="/onboarding/location">3</Link>
                      </li>
            ...
            <div className="px-4 py-8">
              <div className="max-w-md mx-auto">
                ...
                <h1 className="text-3xl text-slate-800 font-bold mb-6">Where will you be primarily delivering orders from ?</h1>
